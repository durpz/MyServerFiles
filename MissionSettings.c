...
#include "$CurrentDir:\\mpmissions\\empty.banov\\SurvivorMissionModule\\EventsWorldData_banov.c"
...
{	
	...
	static int DelayTime = 1400;				//seconds (!Do not set lower than 300 seconds), delay time of first and between previous and next mission
